...
var/global/datum/not_incapacitated_state = new /datum/ui_state/not_incapacitated_state
...
var/global/datum/not_incapacitated_turf_state = new  /datum/ui_state/not_incapacitated_state(no_turfs = TRUE)
